...
1.  User requests to view a report of expenditure record in the account which they are viewing right now. +
...
1.  User requests to export a report of expenditure record in the account which they are viewing right now. +
...
==== Delete account
.. Prerequisites: +
The account which you want to delete, must exist in account list. +

...
.Sequence Diagram for Report View Command Creation
image::ReportViewCreation.png[]

.Sequence Diagram for Report View Command Execution
...
4. Only months with expenditures more than 0 dollars will be reported.
...
.. Test case: `report export -sd 2020-04-01 -ed 2020-05-31 -g bar -o tag -f file` +
Expected: Bar chart with spending categorised by tags will be
exported. If there are no tags, then

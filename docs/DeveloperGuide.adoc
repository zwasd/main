...
executed. The execution will pop out the _ReportWindow_ which will showcase a expenditure breakdown report.
...
executed. The execution will send a print job to your printer, printing out the report.
...
executed. The execution will export a PDF version of the report into your computer.

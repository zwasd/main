...
** 1a2. Back to step 1.
** use case end.
* 2a. Duplicate account name.
** 2a1. `$AVE IT` will state that duplicate account name detected. Unable to add.
** 2a2. Back to step 1.
** Use case end.
...
1.  User requests to add a new account. Format: `acc delete "account name" `
...
** 1a2. Back to step 1.
** use case end.
* 1b. Non existent account name.
** 1b1. `$AVE IT` will state that account is not found. Unable to delete.
** 1b2. Back to step 1.
** Use case end.
* 2a. Deleted the only account in the list.
** 2a1. `$AVE IT` will create a default account to ensure there is at least an account in the list
** Use case end.
* 2b. Deleted the account which you are viewing right now.
** 2b1. `$AVE IT` will randomly checkout to an existing account.
** Use case end.
...
** 1b2. Back to step 1.
** use case end.
* 2a. Tag is not specified.
** 2a1. `$AVE IT` will auto assign it to be `others`
** Back to step 1.
** use case end.
* 2b. Date is not specified.
** 2b1. `$AVE IT` will add this expenditure record to the day which the calendar states.
** 2b2. Back to step 1.
** use case end.
...
** 1b2. Back to step 1.
** use case end.
* 1c. Invalid start date or end date.
** 1c1. `$AVE IT` will request an valid and date.
** 1c2. `$AVE IT` will ensure that the `end date` is same or after the `start date`.
** 1c2. Back to step 1.
** use case end.
* 1d. Invalid Period.
** 1d1. `$AVE IT` will only supports period to be `daily`, `weekly`, `monthly` and `annually`.
** 1d2. Back to step 1.
** Use can end.
* 2a. Tag is not specified.
** 2a1. `$AVE IT` will auto assign it to be `others`
...
[discrete]
=== Use case: Report View [TO BE IMPLEMENTED]

*MSS*

1.  User requests to view an report of expenditure record in the account which they are viewing right now. +
Format: `report view startDate (YYYY-MM-DD) endDate(YYYY-MM-DD) `
2.  `$AVE IT` will acknowledge and pop up another video to show the relevant report.
+

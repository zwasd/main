...
1.  User requests to view report of their spending for a specific time. Format: `reportview "START DATE(DDMMYYYY)" "END DATE(DDMMYYYY)" "GRAPH(PIE)""`.
...
1.  User requests to export a report of their spending in a specific time. Format: reportexport "START DATE(DDMMYYYY)" "END DATE(DDMMYYYY)"`.

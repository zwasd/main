...
public class JsonSerializableAccountTest {
    ...
    public void toModelType_typicalPersonsFile_success() throws Exception {
        JsonSerializableAccount dataFromFile = JsonUtil.readJsonFile(TYPICAL_PERSONS_FILE,
                JsonSerializableAccount.class).get();
    ...
    public void toModelType_invalidPersonFile_throwsIllegalValueException() throws Exception {
        JsonSerializableAccount dataFromFile = JsonUtil.readJsonFile(INVALID_PERSON_FILE,
                JsonSerializableAccount.class).get();
    ...
    public void toModelType_duplicatePersons_throwsIllegalValueException() throws Exception {
        JsonSerializableAccount dataFromFile = JsonUtil.readJsonFile(DUPLICATE_PERSON_FILE,
                JsonSerializableAccount.class).get();

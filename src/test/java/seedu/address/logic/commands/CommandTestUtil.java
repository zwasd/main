...
public class CommandTestUtil {
    ...
    public static final String EMAIL_DESC_AMY = " " + PREFIX_AMOUNT + VALID_EMAIL_AMY;
    public static final String EMAIL_DESC_BOB = " " + PREFIX_AMOUNT + VALID_EMAIL_BOB;
    ...
    public static final String INVALID_EMAIL_DESC = " " + PREFIX_AMOUNT + "bob!yahoo"; // missing '@' symbol
    ...
    public static void showPersonAtIndex(Model model, Index targetIndex) {
        ...
        final String[] splitName = expenditure.getName().fullName.split("\\s+");

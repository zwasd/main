...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        assertParseFailure(parser, "1" + INVALID_NAME_DESC, Info.MESSAGE_CONSTRAINTS); // invalid name
        ...
        assertParseFailure(parser, "1" + INVALID_ADDRESS_DESC, Id.MESSAGE_CONSTRAINTS); // invalid address

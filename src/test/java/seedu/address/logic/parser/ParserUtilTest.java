...
public class ParserUtilTest {
    ...
    public void parseName_invalidValue_throwsParseException() {
        assertThrows(ParseException.class, () -> ParserUtil.parseInfo(INVALID_NAME));
    }
    ...
    public void parseName_validValueWithWhitespace_returnsTrimmedName() throws Exception {
        String nameWithWhitespace = WHITESPACE + VALID_INFO + WHITESPACE;
        Info expectedInfo = new Info(VALID_INFO);
        assertEquals(expectedInfo, ParserUtil.parseInfo(nameWithWhitespace));
    }

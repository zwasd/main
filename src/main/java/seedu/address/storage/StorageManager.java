...
public class StorageManager implements Storage {
    ...
    @Override
    public Optional<ReadOnlyAccount> readAddressBook() throws DataConversionException, IOException {
        return readAddressBook(addressBookStorage.getAddressBookFilePath());
    }

    @Override
    public Optional<ReadOnlyAccount> readAddressBook(Path filePath) throws DataConversionException, IOException {

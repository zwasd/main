...
public class EditCommand extends Command {
    ...
    private static Expenditure createEditedPerson(Expenditure expenditureToEdit,
        ...
        Phone updatedPhone = editPersonDescriptor.getPhone().orElse(expenditureToEdit.getPhone());
        ...
        return new Expenditure(updatedName, updatedPhone, updatedAmount, updatedAddress, updatedTags);
    }
    ...
    public static class EditPersonDescriptor {
        ...
        public boolean isAnyFieldEdited() {
            return CollectionUtil.isAnyNonNull(name, phone, amount, address, tags);
        }

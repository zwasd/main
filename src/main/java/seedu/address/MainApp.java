...
public class MainApp extends Application {
    ...
    public void init() throws Exception {
        ...
        AddressBookStorage addressBookStorage = new JsonAddressBookStorage(userPrefs.getAccountFilePath());
    ...
    /**
     * Returns a {@code AccountManager} with the data from {@code storage}'s address book and {@code userPrefs}. <br>
    ...
    private Model initModelManager(Storage storage, ReadOnlyUserPrefs userPrefs) {
        ...
        return new AccountManager(initialData, userPrefs);
    }
    ...
    public void start(Stage primaryStage) {
        logger.info("Starting Account " + MainApp.VERSION);
        ui.start(primaryStage);
    }

    @Override
    public void stop() {
        logger.info("============================ [ Stopping Id Book ] =============================");
        try {

...
public class Account implements ReadOnlyAccount {
    ...
    public void resetData(ReadOnlyAccount newData) {
        ...
        setPersons(newData.getAccountList());
    }
     ...
     * The expenditure identity of {@code editedExpenditure} must not be the same as another existing expenditure in the address book.
     */

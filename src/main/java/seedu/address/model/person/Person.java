...
public class Person {
     ...
     */
    public Person(Info info, Phone phone, Email email, Address address, Set<Tag> tags) {
        requireAllNonNull(info, phone, email, address, tags);
        this.info = info;
        this.phone = phone;
        this.email = email;
    ...
    public int hashCode() {
        ...
        return Objects.hash(info, phone, email, address, tags);
    }
